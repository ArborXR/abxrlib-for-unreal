...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Abxr")
	void LogDebug(const FString& Text, const TMap<FString, FString>& Meta);
	void LogDebug(const FString& Text) { LogDebug(Text, TMap<FString, FString>()); }

	UFUNCTION(BlueprintCallable, Category = "Abxr")
	void LogInfo(const FString& Text, const TMap<FString, FString>& Meta);
	void LogInfo(const FString& Text) { LogInfo(Text, TMap<FString, FString>()); }

	UFUNCTION(BlueprintCallable, Category = "Abxr")
	void LogWarn(const FString& Text, const TMap<FString, FString>& Meta);
	void LogWarn(const FString& Text) { LogWarn(Text, TMap<FString, FString>()); }

	UFUNCTION(BlueprintCallable, Category = "Abxr")
	void LogError(const FString& Text, const TMap<FString, FString>& Meta);
	void LogError(const FString& Text) { LogError(Text, TMap<FString, FString>()); }

	UFUNCTION(BlueprintCallable, Category = "Abxr")
	void LogCritical(const FString& Text, const TMap<FString, FString>& Meta);
	void LogCritical(const FString& Text) { LogCritical(Text, TMap<FString, FString>()); }

	UFUNCTION(BlueprintCallable, Category = "Abxr")
	void Log(const FString& Text, ELogLevel Level, TMap<FString, FString> Meta);
	void Log(const FString& Text, ELogLevel Level) { Log(Text, Level, TMap<FString, FString>()); }
	void Log(const FString& Text) { Log(Text, ELogLevel::Info, TMap<FString, FString>()); }

	UFUNCTION(BlueprintCallable, Category = "Abxr")
	void Event(const FString& Name, TMap<FString, FString> Meta);
	void Event(const FString& Name) { Event(Name, TMap<FString, FString>()); }
	...
	void Telemetry(const FString& Name) { Telemetry(Name, TMap<FString, FString>()); }
	...
	UFUNCTION(BlueprintCallable, Category = "Abxr")
	void EventInteractionComplete(const FString& InteractionName, EInteractionType InteractionType, const FString& Response, TMap<FString, FString>& Meta);
	void EventInteractionComplete(const FString& InteractionName, EInteractionType InteractionType, const FString& Response)
	{
		TMap<FString, FString> Meta;
	...
	UFUNCTION(BlueprintCallable, Category = "Abxr")
	void EventCritical(const FString& Label, const TMap<FString, FString>& Meta);
	void EventCritical(const FString& Label) { EventCritical(Label, TMap<FString, FString>()); }

	UFUNCTION(BlueprintCallable, Category = "Abxr")
	void PresentKeyboard(const FString& PromptText, const FString& KeyboardType, const FString& EmailDomain);
	void PresentKeyboard(const FString& PromptText, const FString& KeyboardType) { PresentKeyboard(PromptText, KeyboardType, FString("")); }
