...
bool UAbxrSettings::IsValid() const
{
    ...
    {
		UE_LOG(LogAbxrLib, Error, TEXT("[AbxrLib] Invalid Application ID format. Must be a valid UUID. Cannot authenticate."));
        return false;
    }
    ...
    {
        UE_LOG(LogAbxrLib, Error, TEXT("[AbxrLib] Invalid Organization ID format. Must be a valid UUID. Cannot authenticate."));
        return false;
    }
    ...
    if (RestUrl.IsEmpty())
    {
    	UE_LOG(LogAbxrLib, Error, TEXT("[AbxrLib] Configuration validation failed - RestUrl is required but not set"));
        return false;
    }
    
    if (!FAbxrUtil::IsValidUrl(RestUrl))
    {
    	UE_LOG(LogAbxrLib, Error, TEXT("[AbxrLib] Configuration validation failed - RestUrl '%s' is not a valid HTTP/HTTPS URL"), *RestUrl);
        return false;
    }
    ...
    {
        UE_LOG(LogAbxrLib, Error, TEXT("[AbxrLib] Configuration validation failed - "
