...
public:
	...
	UPROPERTY(EditAnywhere, Config, Category="Player Tracking", meta=(DisplayName="Enable Automatic Telemetry"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Player Tracking", meta=(DisplayName="Headset/Controller Tracking"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Player Tracking", meta=(DisplayName="Position Capture Period (seconds)"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Player Tracking", meta=(DisplayName="Enable Scene Events"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Authentication Control", meta=(DisplayName="Enable Auto Start Authentication"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Authentication Control", meta=(DisplayName="Enable Auto Advance Modules"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Frame Rate Tracking Period (seconds)"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Send Retries on Failure"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Send Retry Interval Seconds"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Send Next Batch Wait Seconds"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Straggler Timeout Seconds"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Maximum Data Send Frequency Seconds"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Data Entries Per Send Attempt"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Storage Entries Per Send Attempt"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Prune Sent Items Older Than Hours"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Maximum Cached Items"))
	...
	UPROPERTY(EditAnywhere, Config, Category="Network Configuration", meta=(DisplayName="Retain Local After Sent"))
